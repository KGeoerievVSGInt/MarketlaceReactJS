...
import InventoryModal from "../components/Elements/InventoryElements/InventoryModal";
import InventoryTable from "../components/Elements/InventoryElements/InventoryTable";
import {
  Stack,
  TextField,
  Button,
...
import InventoryLentModal from "../components/Elements/InventoryElements/InventoryLentModal";
const InventoryPage = () => {
  //states
